            ...
            <Box sx={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '1em' }}>
                ...
                <Box
                    ...
                    <Box
                        ...
                        {<a className='white' target={`_blank`} rel='noreferrer' style={{textDecoration:"none"}} href={"https://www.instagram.com/oxi.nab"}>
                ...
                <Box
                    ...
                    <Box
                        ...
                        {<a className='white' target={`_blank`} style={{textDecoration:"none"}} rel='noreferrer' href={"https://www.facebook.com/oxinab.medical"}>
